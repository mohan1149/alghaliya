...
Route::middleware(['IsInstalled', 'auth', 'SetSessionData', 'language', 'timezone', 'bootstrap'])->group(function () {
	...
	Route::post('/pos/checkmanagerpermission','SellPosController@checkStoreManagerPermission');
     ...
     //listing variations popup
    Route::get('/sells/pos/get-pdtservice-List/{p_id}', [ 'as' => 'sells.pos.get-pdtservice-List',
    'uses' => 'SellPosController@getPdtserviceList']);
	Route::get('/sell/product/variation/list/{product_id}', 'SellPosController@getProductVariationList');
    Route::get('/sells/pos/get_variation_row/{variation_id}/{qty}/{location_id}', 'SellPosController@getVariationProductRow');
