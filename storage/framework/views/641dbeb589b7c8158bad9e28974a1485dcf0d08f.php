    ...
    <div class="box-body">
      <div class="row">
       ...
       <div class="col-sm-3">
        ...
        <div class="form-group">
          <div class="checkbox">
            <label>
              <?php echo Form::checkbox('contact_custom_fields[]', 'custom_field1', in_array('custom_field1', $contact_custom_fields), ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('lang_v1.contact_custom_field1'); ?></label>
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-3">
        <div class="form-group">
          <div class="checkbox">
            <label>
              <?php echo Form::checkbox('contact_custom_fields[]', 'custom_field2', in_array('custom_field2', $contact_custom_fields), ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('lang_v1.contact_custom_field2'); ?></label>
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-3">
        <div class="form-group">
          <div class="checkbox">
            <label>
              <?php echo Form::checkbox('contact_custom_fields[]', 'custom_field3', in_array('custom_field3', $contact_custom_fields), ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('lang_v1.contact_custom_field3'); ?></label>
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-3">
        <div class="form-group">
          <div class="checkbox">
            <label>
              <?php echo Form::checkbox('contact_custom_fields[]', 'custom_field4', in_array('custom_field4', $contact_custom_fields), ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('lang_v1.contact_custom_field4'); ?></label>
          </div>
        </div>
      </div>
      <div class="clearfix"></div>
        ...
        <div class="form-group">
          <div class="checkbox">
            <label>
              <?php echo Form::checkbox('location_custom_fields[]', 'custom_field1', in_array('custom_field1', $location_custom_fields), ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('lang_v1.location_custom_field1'); ?></label>
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-3">
        <div class="form-group">
          <div class="checkbox">
            <label>
              <?php echo Form::checkbox('location_custom_fields[]', 'custom_field2', in_array('custom_field2', $location_custom_fields), ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('lang_v1.location_custom_field2'); ?></label>
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-3">
        <div class="form-group">
          <div class="checkbox">
            <label>
              <?php echo Form::checkbox('location_custom_fields[]', 'custom_field3', in_array('custom_field3', $location_custom_fields), ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('lang_v1.location_custom_field3'); ?></label>
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-3">
        <div class="form-group">
          <div class="checkbox">
            <label>
              <?php echo Form::checkbox('location_custom_fields[]', 'custom_field4', in_array('custom_field4', $location_custom_fields), ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('lang_v1.location_custom_field4'); ?></label>
          </div>
        </div>
      </div>
        <div class="col-sm-12">
    ...
    <div class="box-body">
      <div class="row">
        ...
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('product_custom_fields[]', 'product_custom_field1', in_array('product_custom_field1', $product_custom_fields), ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('lang_v1.product_custom_field1'); ?></label>
            </div>
          </div>
        </div>
      ...
      <div class="col-sm-3">
        <div class="form-group">
          <div class="checkbox">
            <label>
              <?php echo Form::checkbox('product_custom_fields[]', 'product_custom_field2', in_array('product_custom_field2', $product_custom_fields), ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('lang_v1.product_custom_field2'); ?></label>
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-3">
        <div class="form-group">
          <div class="checkbox">
            <label>
              <?php echo Form::checkbox('product_custom_fields[]', 'product_custom_field3', in_array('product_custom_field3', $product_custom_fields), ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('lang_v1.product_custom_field3'); ?></label>
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-3">
        <div class="form-group">
          <div class="checkbox">
            <label>
              <?php echo Form::checkbox('product_custom_fields[]', 'product_custom_field4', in_array('product_custom_field4', $product_custom_fields), ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('lang_v1.product_custom_field4'); ?></label>
          </div>
        </div>
      </div>
        <div class="clearfix"></div>
...
<?php if(!empty($enabled_modules) && in_array('types_of_service', $enabled_modules) ): ?>
    <?php echo $__env->make('types_of_service.invoice_layout_settings', ['module_info' => $invoice_layout->module_info], \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php endif; ?>
<!-- Call restaurant module if defined -->
<?php echo $__env->make('restaurant.partials.invoice_layout', ['module_info' => $invoice_layout->module_info, 'edit_il' => true], \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>

<?php if(Module::has('Repair')): ?>
  <?php echo $__env->make('repair::layouts.partials.invoice_layout_settings', ['module_info' => $invoice_layout->module_info, 'edit_il' => true], \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php endif; ?>
