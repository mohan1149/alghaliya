<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-header">
      ...
      <h4 class="modal-title"><?php echo app('translator')->getFromJson( 'purchase.edit_payment' ); ?></h4>
    </div>
    ...
    <div class="modal-body">
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="well">
            <strong><?php echo app('translator')->getFromJson('purchase.supplier'); ?>: </strong><?php echo e($transaction->contact->name, false); ?><br>
        ...
        <div class="col-md-4">
          <div class="well">
            <strong><?php echo app('translator')->getFromJson('purchase.ref_no'); ?>: </strong><?php echo e($transaction->ref_no, false); ?><br>
      ...
      <div class="row payment_row">
        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            <p class="help-block"><?php echo app('translator')->getFromJson('lang_v1.previous_file_will_be_replaced'); ?></p>
          </div>
        </div>
        ...
        <div class="clearfix"></div>
          <?php echo $__env->make('transaction_payment.payment_type_details', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <div class="col-md-12">
          <div class="form-group">
