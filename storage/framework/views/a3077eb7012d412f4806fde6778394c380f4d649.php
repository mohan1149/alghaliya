...
<section class="content">
	...
	<?php $__env->startComponent('components.widget', ['title' => __('essentials::lang.todo_list'), 'icon' => '<i class="ion ion-clipboard"></i>', 'class' => 'box-primary']); ?>
		<?php $__env->slot('tool'); ?>
			<div class="box-tools">
...
<?php echo $__env->make('essentials::todo.update_task_status_modal', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
$('#task_modal').on('shown.bs.modal', function() {
	...
	CKEDITOR.replace('to_do_description');
