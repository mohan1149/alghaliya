						...
						<div class="row">
							<div id="payment_rows_div">
								<?php $__currentLoopData = $payment_lines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment_line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									...
									<?php echo $__env->make('sale_pos.partials.payment_row', ['removable' => !$loop->first, 'row_index' => $loop->index, 'payment_line' => $payment_line], \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
	...
	<div class="modal-dialog" role="document">
		...
		<div class="col-md-4">
			<div class="form-group">
				...
				<?php echo Form::text("", null, ['class' => 'form-control','required', 'placeholder' => __('lang_v1.card_transaction_no'), 'id' => "card_transaction_number"]);; ?>
		...
		<div class="col-md-4">
			<div class="form-group">
				...
				<?php echo Form::select('card_type', ['knet' => 'KNET','visa' => 'Visa', 'master' => 'MasterCard'], 'knet', ['class'=>'form-control select2','id'=>'card_type']); ?>
		...
		<div class="col-md-12">
			<div class="form-group">
				<?php echo Form::label("card_transaction_notes",__('lang_v1.card_transaction_notes')); ?>

				<?php echo Form::textarea("", null, ['class' => 'form-control', 'placeholder' => __('lang_v1.card_transaction_notes'), 'id' => "card_transaction_notes"]);; ?>
