...
<?php echo Form::open(['url' => action('ManageUserController@store'), 'method' => 'post', 'id' => 'user_add_form' ]); ?>
  ...
  <div class="col-md-12">
			...
			<div class="col-md-12">
                    <div class="checkbox">
                      <label>	
                        ...
                        <?php echo Form::checkbox('OEX_SHOW_HRM', 'OEX_SHOW_HRM', false, 
                      ...
                      <label>	
                        ...
                        <?php echo Form::checkbox('OEX_SHOW_POSTAB', 'OEX_SHOW_POSTAB', false, 
                      ...
                      <label>	
                        ...
                        <?php echo Form::checkbox('OEX_STORE_MANAGER', 'OEX_STORE_MANAGER', false, 
                      ...
                      <label>	
                        ...
                        <?php echo Form::checkbox('OEX_STOCK_TRANSFER_APPROVAL', 'OEX_STOCK_TRANSFER_APPROVAL', false, 
    ...
    <?php echo $__env->make('user.edit_profile_form_part', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <div class="row">
    <div class="col-md-12">
