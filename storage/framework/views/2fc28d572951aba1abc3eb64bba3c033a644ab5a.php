  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      <div class="row">
        ...
        <div class="col-sm-3">
        <div class="form-group">
            <?php echo Form::label('custom_field1', __('lang_v1.location_custom_field1') . ':'); ?>
      ...
      <div class="col-sm-3">
        <div class="form-group">
            <?php echo Form::label('custom_field2', __('lang_v1.location_custom_field2') . ':'); ?>
      ...
      <div class="col-sm-3">
        <div class="form-group">
            <?php echo Form::label('custom_field3', __('lang_v1.location_custom_field3') . ':'); ?>
      ...
      <div class="col-sm-3">
        <div class="form-group">
            <?php echo Form::label('custom_field4', __('lang_v1.location_custom_field4') . ':'); ?>
