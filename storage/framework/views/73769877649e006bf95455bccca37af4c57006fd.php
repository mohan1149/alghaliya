    ...
    <?php $__env->startComponent('components.widget', ['class' => 'box-primary']); ?>
        ...
        <div class="col-md-9">
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('permissions[]', 'total_view', in_array('total_view', $role_permissions), ['class' => 'input-icheck']);; ?>

                <?php echo e(__('lang_v1.total_view'), false); ?>
        ...
        <?php echo $__env->make('role.partials.module_permissions', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <div class="row">
        <div class="col-md-12">
