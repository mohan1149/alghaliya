...
<?php echo Form::open(['url' => action('ProductController@store'), 'method' => 'post', 
    ...
    <?php $__env->startComponent('components.widget', ['class' => 'box-primary']); ?>
        ...
        <!--custom fields-->
        <div class="clearfix"></div>
        <?php echo $__env->make('layouts.partials.module_form_part', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
      </div>
    <?php echo $__env->renderComponent(); ?>
    ...
    <?php $__env->startComponent('components.widget', ['class' => 'box-primary']); ?>
        ...
        <div class="col-sm-4">
          <div class="form-group">
            <?php echo Form::label('subscription_definition', __('product.subscription_definition') . ':*'); ?>

              <?php echo Form::select('subscription_definition', ['none'=>'None','meal'=>'Meal','snack'=>'Snack'], 'none', ['class' => 'form-control select2', 'required']);; ?>
        ...
        <div class="form-group col-sm-12" id="product_form_part">
          <?php echo $__env->make('product.partials.single_product_form_part', ['profit_percent' => $default_profit_percent], \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        </div>
