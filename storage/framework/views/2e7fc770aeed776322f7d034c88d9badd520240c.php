        ...
        <div class="col-md-12">
           <?php $__env->startComponent('components.filters', ['title' => __('report.filters')]); ?>
              <?php echo Form::open(['url' => '#', 'method' => 'get', 'id' => 'sell_payment_report_form' ]); ?>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <?php echo Form::select('payment_types', $payment_types, null, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'required']);; ?>
                ...
                <div class="col-md-3">  
                    <div class="form-group">
                        <?php echo Form::label('payment_types', __('Payment Status').':'); ?>

                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="fa fa-money"></i>
                            </span>
                            <?php echo Form::select('payment_status', ['paid'=>'Paid','due'=>'Due'], null, ['class' => 'form-control select2','id'=>'payment_status', 'placeholder' => __('messages.please_select'), 'required']);; ?>
                ...
                <div class="col-md-3">
                 ...
                 <div class="col-md-3">
                    <div class="form-group">
                        <?php echo Form::label('customer_group_id', __('contact.customer_group') . ':'); ?>

                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="fa fa-user"></i>
                            </span>
                            <?php echo Form::select('customer_group_id', $cust_group, null, ['class' => 'form-control select2']);; ?>
                    ...
                    id="sell_payment_report_table">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo app('translator')->getFromJson('contact.customer_group'); ?></th>
