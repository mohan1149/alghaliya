    ...
    <div class="row">
      ...
      <?php if(in_array('types_of_service' ,$enabled_modules)): ?>
        ...
        <?php if(!empty($sell->types_of_service->enable_custom_fields)): ?>
          <strong><?php echo app('translator')->getFromJson('lang_v1.service_custom_field_1'); ?>:</strong>
          <?php echo e($sell->service_custom_field_1, false); ?><br>
          <strong><?php echo app('translator')->getFromJson('lang_v1.service_custom_field_2'); ?>:</strong>
          <?php echo e($sell->service_custom_field_2, false); ?><br>
          <strong><?php echo app('translator')->getFromJson('lang_v1.service_custom_field_3'); ?>:</strong>
          <?php echo e($sell->service_custom_field_3, false); ?><br>
          <strong><?php echo app('translator')->getFromJson('lang_v1.service_custom_field_4'); ?>:</strong>
    ...
    <div class="row">
      ...
      <div class="col-sm-12 col-xs-12">
        <div class="table-responsive">
          <?php echo $__env->make('sale_pos.partials.sale_line_details', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        </div>
      </div>
    </div>
