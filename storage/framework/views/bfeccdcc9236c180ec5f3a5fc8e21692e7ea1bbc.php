            ...
            <?php if(in_array($transaction->type, ['purchase', 'purchase_return'])): ?>
                <div class="row invoice-info">
                    <div class="col-sm-4 invoice-col">
                        <?php echo $__env->make('transaction_payment.transaction_supplier_details', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    </div>
                    <div class="col-md-4 invoice-col">
                        <?php echo $__env->make('transaction_payment.payment_business_details', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    </div>
                    ...
                    <div class="col-sm-4 invoice-col">
                        ...
                        <b><?php echo app('translator')->getFromJson('purchase.purchase_status'); ?>:</b> <?php echo e(ucfirst( $transaction->status ), false); ?><br>
                        <b><?php echo app('translator')->getFromJson('purchase.payment_status'); ?>:</b> <?php echo e(ucfirst( $transaction->payment_status ), false); ?><br>
                    </div>
                </div>
                    ...
                    <div class="col-sm-4 invoice-col">
                        ...
                        <address>
                            ...
                            <?php if(!empty($transaction->transaction_for->email)): ?>
                                <br>Email: <?php echo e($transaction->transaction_for->email, false); ?>
