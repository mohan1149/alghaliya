    ...
    <div class="modal-body">
      ...
      <div class="form-group">
        <?php echo Form::label('subscription_amout', __( 'lang_v1.subscription_cost' ) . ':*'); ?>
          ...
          <?php echo Form::text('subscription_amout', $customer_group->subscription_cost, ['class' => 'form-control input_number', 'required', 'placeholder' => __( 'lang_v1.subscription_cost' ) ]);; ?>
