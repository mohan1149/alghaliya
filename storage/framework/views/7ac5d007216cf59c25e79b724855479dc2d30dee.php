...
<section class="content no-print">
    ...
    <?php endif; ?>
	<div class="row">
		<div class="<?php if(!empty($pos_settings['hide_product_suggestion']) && !empty($pos_settings['hide_recent_trans'])): ?> col-md-5 col-md-offset-1 <?php else: ?> col-md-5 <?php endif; ?> col-sm-12">
				...
				<div class="box-header with-border">
					<h3 class="box-title">
						...
						<?php if($transaction->status == 'draft' && $transaction->is_quotation == 1): ?> 
							<?php echo app('translator')->getFromJson('lang_v1.quotation'); ?>
					...
					<p><strong><?php echo app('translator')->getFromJson('sale.location'); ?>:</strong> <?php echo e($transaction->location->name, false); ?></p>
                ...
                ?>
							...
							<div class="modal fade types_of_service_modal" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel">
								<?php if(!empty($transaction->types_of_service)): ?>
									<?php echo $__env->make('types_of_service.pos_form_modal', ['types_of_service' => $transaction->types_of_service], \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
								<?php endif; ?>
							</div>
						<?php endif; ?>
						...
						<?php if(in_array('subscription', $enabled_modules)): ?>
							<div class="col-md-4 pull-right col-sm-6">
								<div class="checkbox">
								<label>
								<?php echo Form::checkbox('is_subscription', 1, ($transaction->subscription_id!=null), ['id' => 'is_subscription']);; ?> <?php echo app('translator')->getFromJson('lang_v1.subscribe'); ?>?
								</label>
									<!-- <label>
                ...
                ?> -->
					...
					<div class="row col-sm-12 pos_product_div">
						...
						<table class="table table-condensed table-bordered table-striped table-responsive" id="pos_table">
							<thead>
								<tr>
									<th class="text-center <?php if(!empty($pos_settings['inline_service_staff'])): ?> col-md-3 <?php else: ?> col-md-4 <?php endif; ?>">	
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					...
					<?php echo $__env->make('sale_pos.partials.pos_details', ['edit' => true], \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
