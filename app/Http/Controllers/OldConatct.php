...
class ContactController extends Controller
{
        ...
        try {
            ...
            if ($count == 0) {
                ...
                if($request['type'] == 'customer'){
                    $input['custom_field1'] = $request['custom_field1'] * (0 / 100) + $request['custom_field1'];
                    $input['custom_field2'] =  0;
                    $input['custom_field3'] = $request['custom_field1'] * (0 / 100) + $request['custom_field1'];
    ...
    public function renewCustomerSubscriptionPlan(Request $request){
        try{
            ...
            ->update([
                'custom_field1' => $check * (0 / 100) + $customer->custom_field3 + $check,
                'custom_field2' => 0,
                'custom_field3' => $check * (0 / 100) + $customer->custom_field3 + $check,
