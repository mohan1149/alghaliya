            ...
            return Datatables::of($todos)
                ->addColumn(
                    ...
                    function ($row) use ($is_admin, $auth_id) {
                        ...
                        $html .= '<li><a href="#" class="change_status" data-status="' . $row->status . '" data-task_id="' . $row->id . '"><i class="fa fa-check-circle-o"></i> ' . __("essentials::lang.change_status") . '</a></li></ul></div>';
