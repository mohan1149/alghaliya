$(document).ready(function() {
 ...
 { data: 'sku', name: 'variations.sub_sku' },
    ...
    sell_payment_report = $('table#sell_payment_report_table').DataTable({
        ...
        ajax: {
            ...
            data: function(d) {
                ...
                d.customer_group_id = $('select#customer_group_id').val();
                var start = '';
                var end = ''; 
        ...
        columns: [
            ...
            { data: 'ctype', name: 'ctype',orderable: false, searchable: false},
            { data: 'method', name: 'method' },
    ...
    $('#sell_payment_report_form #location_id, #sell_payment_report_form #customer_id,#sell_payment_report_form #customer_group_id, #sell_payment_report_form #payment_types, #sell_payment_report_form #payment_status').change(
        function() {
            sell_payment_report.ajax.reload();
        }
    );
